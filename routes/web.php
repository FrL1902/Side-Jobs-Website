...
Route::get('/userApplies', [JobController::class, 'user_applies_job']);
...
Route::get('/activeJobs', [JobController::class, 'active_jobs_page']);
Route::get('/pastJobs', [JobController::class, 'past_jobs_page']);
